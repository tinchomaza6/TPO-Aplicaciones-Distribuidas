...
<body>
	...
	<h2 class="text-center">Menu Administracion de Compras</h2>
	<h6 class="text-center text-muted">Seleccione la opcion</h6>
	<div id="menuesLindos" style="width: 370px; margin: 75px auto;">
		<button class="btn btn-primary btn-lg btn-block" type="button" onclick="location.href='Inicio?action=showOP'">Ver Ordenes de pedido</button>
		<button class="btn btn-primary btn-lg btn-block" type="button" onclick="location.href='Inicio?action=showOC'">Completar Ordenes de compra</button>
	</div>
