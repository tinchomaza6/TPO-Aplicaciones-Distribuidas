...
<body>
	...
	<h2 class="text-center">Menu Administracion de Despacho</h2>
	<h6 class="text-center text-muted">Seleccione la opcion</h6>
	<div id="menuesLindos" style="width: 390px; margin: 75px auto;">
		<button class="btn btn-primary btn-lg btn-block" type="button" onclick="location.href='Inicio?action=pedidosDespacho'">Ver Pedidos en Espera de Despacho</button>
		<button class="btn btn-primary btn-lg btn-block" type="button" onclick="location.href='Inicio?action=pedidosEnvio'">Ver Pedidos en Espera de Envio</button>
	</div>
