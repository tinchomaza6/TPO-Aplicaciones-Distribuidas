...
<body>
    ...
    <h2 class="text-center">Baja Cliente</h2>
    <form class="bootstrap-form-with-validation" method="post" action="Inicio?action=eliminarCliente">
        <div class="form-group">
            <label class="control-label" for="text-input"> </label>
            <h6 class="text-left text-muted">Ingrese DNI del cliente a dar de baja</h6>
