...
<body>
    ...
    <h2 class="text-center">Reportar Inconsistencia</h2>
    <h6 class="text-center text-muted">Ingrese datos de la inconsistencia</h6>
    <form class="form-horizontal custom-form" method="post" action="Inicio?action=registrarInconsistencia">
        <div class="form-group">
            <div class="col-sm-12">
                <label class="control-label" for="pawssword-input-field">Id Articulo </label>
        ...
        <div class="form-group">
            <div class="col-sm-12">
                <label class="control-label" for="email-input-field">Descripcion</label>
                <input class="form-control" type="text" name="descripcion" placeholder="Descripcion">
            </div>
        </div>
        <div class="form-group">
            <div class="col-sm-12">
                <label class="control-label" for="email-input-field">Lote </label>
                <input class="form-control" type="number" name="idLote" placeholder="Lote">
            </div>
        </div>
        <div class="form-group">
            <div class="col-sm-12">
                <label class="control-label" for="email-input-field">Ubicacion </label>
                <input class="form-control" type="text" name="idUbicacion" placeholder="Ubicacion">
            </div>
        </div>
